...
const PersonalPay = () => {
  return (
    <DashboardShell
      title="Your Account"
      subtitle="Transfer to other wallets, manage balances, and track outgoing payments"
      actions={
        <>
          ...
          <Link
            to="/personal/send-to-wallet"
            className="flex h-14 items-center justify-center gap-2 rounded-2xl bg-black px-6 text-base font-medium text-white transition hover:opacity-90"
          >
