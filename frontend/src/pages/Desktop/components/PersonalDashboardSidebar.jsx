...
const PersonalDashboardSidebar = () => {
  return (
    <div className="swift desktop-view homepage p-md-4 p-3 bg-black h-100">
        <header className="d-flex align-items-center justify-content-start">
          <img className="dashboard-logo" src="/img/logo-inverted.png" alt="Logo" />
        </header>
        <ul class="sidebar-items p-0">
          ...
          <li className="list-unstyled text-white px-3 d-flex align-items-center">
            ...
            <a href="" className="text-decoration-none text-white">Pay</a>
          </li>
          <li className="list-unstyled text-white px-3 d-flex align-items-center">
            <TbArrowsExchange size={25} className="me-3" />
            <a href="" className="text-decoration-none text-white">Transactions</a>
          </li>
          <li className="list-unstyled text-white px-3 d-flex align-items-center">
            <BsCreditCard2Front size={25} className="me-3" />
            <a href="" className="text-decoration-none text-white">Cards</a>
          </li>
          <li className="list-unstyled text-white px-3 d-flex align-items-center">
            <TbReportSearch size={25} className="me-3" />
            <a href="" className="text-decoration-none text-white">Expenses</a>
          </li>
          <li className="list-unstyled text-white px-3 d-flex align-items-center">
            <TbReportAnalytics size={25} className="me-3" />
            <a href="" className="text-decoration-none text-white">Reports</a>
          </li>
          <li className="list-unstyled text-white px-3 d-flex align-items-center">
            <IoDocumentTextOutline size={25} className="me-3" />
            <a href="" className="text-decoration-none text-white">Documents</a>
          </li>
          <li className="list-unstyled text-white px-3 d-flex align-items-center">
            <LuGoal size={25} className="me-3" />
            <a href="" className="text-decoration-none text-white">Goals</a>
          </li>
          <li className="list-unstyled text-white px-3 d-flex align-items-center">
            <IoSettingsOutline size={25} className="me-3" />
            <a href="" className="text-decoration-none text-white">Settings</a>
          </li>
        </ul>
    </div>
  )
