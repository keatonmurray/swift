  ...
  const aiInsights = [
    {
      ...
      title:
        totalReceived > totalSent
          ...
          : "Outgoing transactions are high",

      description:
        totalReceived > totalSent
          ? "Your incoming transactions currently exceed outgoing transactions."
          : "Your outgoing transactions are currently exceeding incoming transactions.",
    },
    {
      type: "warning",
      title: `${totalTransactions} total transactions detected`,
      description:
        "Your dashboard analytics were generated dynamically from wallet activity.",
    },
  ]
